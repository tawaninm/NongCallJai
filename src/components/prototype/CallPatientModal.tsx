    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content max-w-sm" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex justify-between text-sm mb-4">
          ...
          <div>
            <span className="text-muted-foreground">นัดหมายถัดไป</span>
        ...
        {calling ? (
          <>
            <div className="flex justify-center gap-4 mb-4">
              <button className="flex h-12 w-12 items-center justify-center rounded-full bg-muted hover:bg-muted/80 transition-colors">
              ...
              <button
                ...
                className="flex h-12 w-12 items-center justify-center rounded-full bg-risk-red text-white hover:bg-risk-red/90 transition-colors"
              >
